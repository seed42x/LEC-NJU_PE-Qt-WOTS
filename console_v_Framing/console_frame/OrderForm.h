...
public:
    ...
    //对象函数
    //获取信息
    string get_id() { return id_; }                                 //获取订单ID
    string get_mer_id() { return mer_id_; }                         //获取订单商品ID
    string get_seller_id() { return seller_id_; }                   //获取卖家ID
    string get_buyer_id() { return buyer_id_; }                     //获取买家ID
    double get_uintp() { return uint_price_; }                      //获取商品单价
    int get_num() { return mers_num_; }                             //获取交易数量
    string get_tran_time() { return tran_time_; }                   //获取交易时间
