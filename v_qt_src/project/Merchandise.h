...
public:
    ...
    //管理员
    static void admin_get_all_mers_info(vector<vector<string>>& rst);
    static void admin_get_all_onsale_mers_info(vector<vector<string>>& rst);
    static void admin_select_mers_info(string target_name, vector<vector<string>>& rst);
    //卖家
    static void seller_get_all_mers_info(vector<vector<string>>& rst, string seller_id);
    static void seller_get_all_onsale_mers_info(vector<vector<string>>& rst, string seller_id);
    //买家
    static void buyer_get_all_mers_info(vector<vector<string>>& rst, string buyer_id);
    static void buyer_select_mers_info(string target_name, vector<vector<string>>& rst);
    ...
    string get_seller_id() const { return seller_id_; }
    string get_added_time() const { return added_time_; }
    MerchandiseMode get_mode() const { return state_; }
    string get_state() const { return state_ == ONSALE ? "销售中" : "已下架"; }
};
