...
public:
    ...
    //管理员查看所有订单
    static void admin_get_all_orderforms_info(vector<vector<string>>& rst);

    //卖家查看所有订单
    static void seller_get_all_orderforms_info(vector<vector<string>>& rst, string seller_id);

    //买家查看所有订单
    static void buyer_get_all_orderforms_info(vector<vector<string>>& rst, string buyer_id);
